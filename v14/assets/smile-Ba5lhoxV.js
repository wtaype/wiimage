import{$ as t,f as n,o as c,b as d,h as l,q as r,i as u,d as b,w as f,s as m,e as o,M as h}from"./widev-BfmvTXIU.js";import"./wiauth-Cx-2vr4f.js";t(document).on("click",".logout-btn",async()=>{await n(o),window.location.href="/"});c(o,async s=>{if(!s)return window.location.href="/";try{const a=d("wiSmile");if(a)return e(a);const i=(await l(r(u(b,"smiles"),f("usuario","==",s.displayName)))).docs[0].data();m("wiSmile",i,450),e(i)}catch(a){console.error(a)}});function e(s){console.log(s.nombre),h("Hola "+s.nombre);const a=`
