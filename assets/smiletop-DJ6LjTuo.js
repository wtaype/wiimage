import{o as g,e as h,$ as i,f as y,M as n,B as o,h as d,i as u,d as m,C as $,t as w,D as A}from"./widev-C-URnqc7.js";g(h,async r=>{r?C():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(h),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(r){console.error(r)}});async function C(r){const b=`
