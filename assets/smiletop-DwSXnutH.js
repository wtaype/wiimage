import{o as g,e as h,$ as i,i as y,M as n,F as o,f as d,h as u,d as m,G as $,m as w,n as A}from"./widev-BXwxG9MZ.js";g(h,async r=>{r?S():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(h),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(r){console.error(r)}});async function S(r){const b=`
